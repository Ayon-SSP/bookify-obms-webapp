...
<body>
  ...
  <section id="top-nav" class="bg-secondary">
    <div class="text-center px-md-3 py-md-2">
      <p class="text-white py-1 m-0">Get your first order with free delivery. Offer available to the first 50,000 customers only.
  ...
  <nav class="main-menu d-flex navbar navbar-expand-lg p-2 py-3 p-lg-4 py-lg-4 ">
    <div class="container-fluid">
      <div class="main-logo d-lg-none">
        <a href="index.html">
          <img src="images/bookifyme.png" alt="logo" class="img-fluid" id="img-logo">
        </a>
      </div>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body justify-content-between">
          ...
          <ul class="navbar-nav menu-list list-unstyled align-items-lg-center d-flex gap-md-3 mb-0">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link mx-2 dropdown-toggle align-items-center" role="button" id="books"
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="blog">
                <li><a href="blog.html" class="dropdown-item">Book Categories<span
                      class="badge bg-secondary text-white ms-2">PRO</span></a></li>
  ...
  <section id="hero" style="background-image:url(images/billboard-bg.png); background-repeat: no-repeat; background-position: center;">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 pe-5 mt-5 mt-md-0">
          <h2 class="display-1 text-uppercase">Master Your Order</h2>
          <p class="fs-4 my-4 pb-2">Ignite Your Imagination!</p>
          <div>
            <form id="form" class="d-flex align-items-center position-relative ">
              <input type="text" name="email" placeholder="what are you trying to read?"
        ...
        <div class="col-md-6 mt-3">
          <img src="images/bookstack.png" alt="img" class="img-fluid animate-float-rotate">
          <!-- <img src="images/7273746.png" alt="img" class="img-fluid"> -->
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-md-3 col-sm-6 mb-5 mb-md-0">
          <div class="feature-item py-5  rounded-4">
            <div class="feature-detail text-center">
              ...
              <h6 class="feature-info text-uppercase">Authors</h6>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-5 mb-md-0">
          <div class="feature-item py-5  rounded-4">
            <div class="feature-detail text-center">
              ...
              <h6 class="feature-info text-uppercase">books</h6>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-5 mb-md-0">
          <div class="feature-item py-5  rounded-4">
            <div class="feature-detail text-center">
              ...
              <h6 class="feature-info text-uppercase">Goodies</h6>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-5 mb-md-0">
    ...
    <div class="container">
      <div class="row align-items-center mt-xl-5">
        <div class="offset-md-1 col-md-5">
          <img src="images/about-img.jpg" alt="img" class="img-fluid rounded-circle" id="about-img">
        </div>
        <div class="col-md-5 mt-5 mt-md-0">
          ...
          <p>Welcome to Bookify - A diverse collection of books from around the world. Founded in 2024, our mission is to inspire, educate, and entertain readers of all ages and backgrounds. Browse, discover, and fall in love with stories that shape imagination and spark curiosity. Experience the Bookify difference today, and join our book-loving community!</p>
          <div class="d-flex">
          ...
          <div class="d-flex">
            ...
            <p class="ps-4">Get a book of your choice from the Best Authors around the world</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
              <use href="#tick-circle" class="text-secondary" />
        ...
        <div class="col-md-4">
          <div class="primary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Science Fiction</p>
                <p class="category-paragraph m-0">30+ books</p>
              </div>
            </div>
          </div>
          <div class="tertiary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Magzines</p>
                <p class="category-paragraph m-0">4 books</p>
              </div>
            </div>
          </div>
          <div class="tertiary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Paperback</p>
                <p class="category-paragraph m-0">2 books</p>
              </div>
            </div>
          </div>
          <div class="secondary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Hardcover</p>
                <p class="category-paragraph m-0">2 books</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="gray rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Audiobooks</p>
                <p class="category-paragraph m-0">1 books</p>
              </div>
            </div>
          </div>
          <div class="secondary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Ebooks</p>
                <p class="category-paragraph m-0">2 books</p>
              </div>
            </div>
          </div>
          <div class="tertiary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Comics</p>
                <p class="category-paragraph m-0">2 books</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="tertiary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Graphic Novels</p>
                <p class="category-paragraph m-0">2 books</p>
              </div>
            </div>
          </div>
          <div class="primary rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Young Adult </p>
                <p class="category-paragraph m-0">1 books</p>
              </div>
            </div>
          </div>
          <div class="gray rounded-3 p-4 my-3">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <p class="category-paragraph fw-bold text-uppercase mb-1">Childrens Books</p>
                <p class="category-paragraph m-0">1 books</p>
              </div>
            </div>
          </div>
  ...
  <section id="books" class="padding-medium">
    <div class="container">
      <div class="text-center mb-5">
        <p class="text-secondary">Some of our most popular online Books</p>
        <h2 class="display-6 fw-semibold">Explore Our Books</h2>
      </div>
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item1.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Science Fiction</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$59</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">Harry Potter</h5>
              </a>

              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">By: J.K Rowling</p>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item2.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Fantasy Fiction, Novel</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$19</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">The Way of Kings</h5>
              </a>

              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">By:Brandon Sanderson</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item3.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Science Fiction, Horror</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$65</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">The Da Vinci Code</h5>
              </a>

              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">By: Dan Brown</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item4.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">

              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Mystery, Poetry</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$44</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">The Lord of The Rings</h5>
              </a>

              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">By: J. R. R. Tolkien</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item5.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Mystery, Horror, Thriller</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$54</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">The Shining</h5>
              </a>

              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">By:Stephen King</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item6.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Science Fiction, Fantasy</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$9</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">Dune</h5>
              </a>

              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">By: Frank Herbert</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item7.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Thriller, Mystery</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$57</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">Inferno</h5>
              </a>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="book-card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href=${homeService.author.getAuthorId()}><img src="images/BookImages/item8.jpg"
                class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
              <div class="d-flex justify-content-between my-3">
                <p class="text-black-50 fw-bold text-uppercase m-0">Novel</p>
                <div class="d-flex align-items-center">
                  <svg width="20" height="20">
                    <use xlink:href="#clock" class="text-black-50"></use>
                  </svg>
                  <p class="text-black-50 fw-bold text-uppercase m-0">$17</p>
                </div>
              </div>

              <a href=${homeService.author.getAuthorId()}>
                <h5 class="course-title py-2 m-0">The Light Fantastic</h5>
              </a>

              <div class="card-text">
                <span class="rating d-flex align-items-center mt-3">
                  <p class="text-muted fw-semibold m-0 me-2">By: Terry Pratchett</p>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
                  <iconify-icon icon="clarity:star-solid" class="text-primary"></iconify-icon>
      ...
      <div class="text-center mt-4">
        <a href="courses.html" class="btn btn-primary px-5 py-3">View all Books</a>
      </div>
    </div>
  </section>
  ...
  <section id="Authors" class="padding-medium">
    <div class="container">
      <div class="text-center mb-5">
        <h2 class="display-6 fw-semibold">Our Authors</h2>
      </div>
      <div class="row">
        <div class="col mb-5">
          <div class="team-member position-relative rounded-4 border-0 shadow-sm p-3 author-card">
            <div class="image-holder zoom-effect rounded-3">
              <img class="author_img" src="https://newengland.com/wp-content/uploads/Stephen-King-585x780.jpg"
            ...
            <div class="card-body p-0">
              <div class="text-center mt-3">
                <p class="fw-bold m-0">Stephen King</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col mb-5">
          <div class="team-member position-relative rounded-4 border-0 shadow-sm p-3 author-card">
            <div class="image-holder zoom-effect rounded-3">
              <img
                src="https://m.media-amazon.com/images/M/MV5BYTU2YmU4YWItZjc2Mi00YTNlLThlZmUtYzRmMmI4MThiMDEzXkEyXkFqcGdeQXVyNDUzOTQ5MjY@._V1_.jpg"
                class="author_img" class="rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
            ...
            <div class="card-body p-0">
              <div class="text-center mt-3">
                <p class="fw-bold m-0">Brandon Sanderson</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col mb-5">
          <div class="team-member position-relative rounded-4 border-0 shadow-sm p-3 author-card">
            <div class="image-holder zoom-effect rounded-3">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/J._R._R._Tolkien%2C_ca._1925.jpg/800px-J._R._R._Tolkien%2C_ca._1925.jpg"
                class="rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
            ...
            <div class="card-body p-0">
              <div class="text-center mt-3">
                <p class="fw-bold m-0">J. R. R. Tolkien</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col mb-5">
          <div class="team-member position-relative rounded-4 border-0 shadow-sm p-3 author-card">
            <div class="image-holder zoom-effect rounded-3 background">
              <img src="images/Authors/author4.jpg" class="rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
            ...
            <div class="card-body p-0">
              <div class="text-center mt-3">
                <p class="fw-bold m-0">Dan Brown</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col mb-5">
          <div class="team-member position-relative rounded-4 border-0 shadow-sm p-3 author-card">
            <div class="image-holder background2 zoom-effect rounded-3">
              <img src="images/Authors/author5.jpg" class="author_img" class="rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
            ...
            <div class="card-body p-0">
              <div class="text-center mt-3">
                <p class="fw-bold m-0">J. K. Rowling</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row align-items-center mt-5">
        <div class="col-md-6 pe-md-5">
          <div class="d-flex">
            ...
            <p class="ps-4">Speedy Delivery: Receive your orders within a quick timeframe, ensuring a fast and efficient
              delivery.</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px">
            ...
            <p class="ps-4">Curated Library: Browse our expertly-selected collection of books, handpicked from top
              authors worldwide.</p>
          </div>
          <div class="d-flex">
            ...
            <p class="ps-4">Secure Checkout & Fast Delivery: Experience a seamless, secure buying process and quick
              shipping.</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
        ...
        <div class="col-md-6 pe-md-5">
          <div class="d-flex">
            ...
            <p class="ps-4">Global Reach: Access the best books, from local and international authors, all in one place.
            </p>
          </div>
          <div class="d-flex">
            ...
            <p class="ps-4">Mobile-Friendly Design: Enjoy a seamless, effortless browsing experience on any device, be
              it tablet, mobile phone, or desktop.</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="33px" height="33px">
              <use href="#tick-circle" class="text-secondary" />
            </svg>
            <p class="ps-4">Simplified Search: Experience a user-friendly search system, allowing you to quickly find
              the perfect books by author, genre, or title.</p>
          </div>
          <div class="d-flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px">
              <use href="#tick-circle" class="text-secondary" />
            </svg>
            <p class="ps-4">High-Quality Products: Rest assured knowing your chosen books adhere to the highest quality
              standards, showcasing exceptional materials, print, and binding.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="register">
    <div class="container padding-medium">
      <div class="row align-items-center">
        <div class="offset-md-1 col-md-5 ">
          <div>
            <h2 class="display-6 fw-semibold">Subscribe and get 20% OFF on your first Purchase </h2>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-2 my-3">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              ...
              <li class="menu-item mb-2">
                <a href="#" class="footer-link">Authors</a>
              </li>
              <li class="menu-item mb-2">
        ...
        <div class="col-sm-6 col-lg-2 my-3">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              <li class="menu-item mb-2">
                <a href="#" class="footer-link">contact@bookify.com</a>
              </li>
              <li class="menu-item mb-2">
                <a href="#" class="footer-link">+91 99998 00001</a>
              </li>
              <li class="menu-item mb-2">
                <a href="#" class="footer-link">Ahmedabad, India</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row py-3">
        <div class="col-md-6 copyright">
          <p>© 2024 Astral Nexus. All rights reserved.</p>
        </div>
        <div class="col-md-6 text-md-end">
          <p>Full stack project: <a href="https://github.com/Ayon-SSP/Bookify-OBMS/" target="_blank" class="fw-bold">
              Bookify-OBMS</a> </p>
        </div>
      </div>
    </div>
